...
moduleForAcceptance('Acceptance | i i s yet another project yet another class l');

test('testing /i-i-s-yet-another-project-yet-another-class-l', function(assert) {
